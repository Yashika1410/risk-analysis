...
* The original package name 'com.example.risk-analysis' is invalid and this project uses 'com.example.riskanalysis' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.0.6-SNAPSHOT/reference/htmlsingle/#data.sql.jdbc)
